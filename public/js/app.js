...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    submit: function submit() {
      ...
      this.working = true;
      axios.post('/api/payment/addPayment', this.form).then(function (res) {
        _this.working = false;
        _this.form.amount = '';
      })["catch"](function (err) {
        _this.working = false;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deletePayment: function deletePayment(payment) {
      ...
      axios["delete"]("/api/payment/deletePayment/".concat(payment._id)).then(function (res) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    submit: function submit() {
      ...
      this.working = true, axios.post('/api/user/addUser', this.form).then(function (res) {
        if (res.message) {
          alert(res.message);
        }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    //template strings
    axios.get('/api/user/getAllUser').then(function (res) {
  ...
  methods: {
    ...
    deleteUser: function deleteUser(user) {
      ...
      axios["delete"]("/api/user/deleteUser/".concat(user._id)).then(function (res) {
    ...
    _c(
      ...
      [
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "username" } }, [_vm._v("Amount:")]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
        ...
        _c(
          "button",
          {
            ...
            attrs: { type: "submit", disable: _vm.working }
          },
          [
            _vm.working
    ...
    _c("table", { staticClass: "table" }, [
      ...
      _c(
        ...
        _vm._l(_vm.payments, function(payment, index) {
          return _c("tr", [
            _c("td", [_vm._v(_vm._s(_vm.doMath(index)))]),
            _vm._v(" "),
...
var render = function() {
  ...
  return _c("div", { staticClass: "col-lg-6" }, [
    ...
    _c(
      ...
      [
        _c("div", { staticClass: "form-group" }, [
          _c("label", { attrs: { for: "username" } }, [_vm._v("Phone:")]),
          _vm._v(" "),
          _c("input", {
            directives: [
              {
        ...
        _c("div", { staticClass: "form-group" }, [
          ...
          _c("input", {
            ...
            staticClass: "form-control",
            attrs: { type: "text", placeholder: "Site" },
        ...
        _vm._l(_vm.users, function(user, index) {
          return _c("tr", [
            ...
            _c("td", [
              _c(
                "a",
                { staticClass: "btn btn-primary", attrs: { href: user.link } },
                [_vm._v("Pagos")]
              ),
              _vm._v(" "),
              _c(
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('user-list', __webpack_require__(/*! ./components/UserList */ "./resources/js/components/UserList.vue")["default"]);
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('payment-list', __webpack_require__(/*! ./components/PaymentList */ "./resources/js/components/PaymentList.vue")["default"]);
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('user-form', __webpack_require__(/*! ./components/UserForm */ "./resources/js/components/UserForm.vue")["default"]);
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('payment-form', __webpack_require__(/*! ./components/PaymentForm */ "./resources/js/components/PaymentForm.vue")["default"]);
/**
...
__webpack_require__(/*! C:\laragon\www\apirest\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\laragon\www\apirest\resources\sass\app.scss */"./resources/sass/app.scss");
